...
print("press g for google")
print("press o for outlook")
print("press y for yahoo")
eService=input("Type it here: ")
eService.lower()
...
def outlook():
    ...
    try:
        ...
        while x:
            server.sendmail(sender,victim,message)
            print("VICTIM IS GETTING BOMBED, lol")
    except Exception as error:   #if there are any errors, they will be printed out as error
        print(error)
...
if eService == "g":
    ...
    print("You did not choose an e-mail service retard")